 ...
 * @return { import("./command").Command<import("../index").Options> }
 */
 ...
 * @param {import("../index").Options} options - A dictionary of options to be set. A null value means that the respective option will be unset.
 * @param {number} [slot] - A slot number.
 * @return { import("./command").Command<import("../index").Options> }
 */
